...
export default async function ({ app, store, redirect }) {
  try {
    ...
    //     console.log('errGet2 ', error, 'refreshToken ', refreshToken)
    //     accountsStorage.get('cererisExpiresIn', async (error, expiresIn) => {
    //       console.log('errGet3 ', error, 'expiresIn ', expiresIn)
